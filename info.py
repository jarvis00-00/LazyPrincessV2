...
# Bot information
SESSION = environ.get('SESSION', 'Damon')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002492948611').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6188248890').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002492948611')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002267551654'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Private_filmy_hub')
...
CAPTION_BUTTON_URL = "https://t.me/Paid_Group_Hub"
